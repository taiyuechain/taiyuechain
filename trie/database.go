...
type Database struct {
	diskdb etaidb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb etaidb.Database) *Database {
...
func NewDatabaseWithCache(diskdb etaidb.Database, cache int) *Database {
...
func (db *Database) Cap(limit common.StorageSize) error {
	...
	if flushPreimages {
		for hash, preimage := range db.preimages {
			...
			if batch.ValueSize() > etaidb.IdealBatchSize {
...
func (db *Database) commit(hash common.Hash, batch etaidb.Batch) error {
