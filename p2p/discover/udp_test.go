...
func TestUDP_findnodeMultiReply(t *testing.T) {
	...
	for i := 0; i < 4; i++ {
		...
		ids[i] = hex.EncodeToString(crypto.FromECDSAPub(&priv.PublicKey)[1:])
	}

	// send the reply as two packets.
	list := []*node{
		wrapNode(enode.MustParseV4("enode://" + ids[0] + "@10.0.1.16:30303?discport=30304")),
		wrapNode(enode.MustParseV4("enode://" + ids[1] + "@10.0.1.16:30303")),
		wrapNode(enode.MustParseV4("enode://" + ids[2] + "@10.0.1.36:30301?discport=17")),
		wrapNode(enode.MustParseV4("enode://" + ids[3] + "@10.0.1.16:30303")),
	}
