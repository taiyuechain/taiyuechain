...
var (
	walletCommand = cli.Command{
		...
		Description: `
	taiyue wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	taiyue wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
	...
	taiyue account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
	...
	taiyue account import [options] <keyfile>
...
func unlockAccount(ctx *cli.Context, ks *keystore.KeyStore, address string, i int, passwords []string) (accounts.Account, string) {
	...
	for trials := 0; trials < 3; trials++ {
		...
		if err == nil {
			log.Info("Unlocked account", "address", crypto.AddressToHex(account.Address))
