...
var (
	walletCommand = cli.Command{
		...
		Description: `
	gtai wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	gtai wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
	...
	gtai account update [options] <address>
