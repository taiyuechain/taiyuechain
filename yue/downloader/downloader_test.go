...
type downloadTester struct {
	...
	stateDb yuedb.Database // Database used by the tester for syncing from peers
	peerDb  yuedb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb = yuedb.NewMemDatabase()
