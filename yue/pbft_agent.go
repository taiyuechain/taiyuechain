...
var (
	oldReceivedMetrics       = metrics.NewRegisteredMeter("yue/pbftAgent/old", nil)
	repeatReceivedMetrics    = metrics.NewRegisteredMeter("yue/pbftAgent/repeat", nil)
	newReceivedMetrics       = metrics.NewRegisteredMeter("yue/pbftAgent/new", nil)
	differentReceivedMetrics = metrics.NewRegisteredMeter("yue/pbftAgent/different", nil)
	nodeHandleMetrics        = metrics.NewRegisteredMeter("yue/pbftAgent/handle", nil)

	tpsMetrics           = metrics.NewRegisteredMeter("yue/pbftAgent/tps", nil)
	pbftConsensusCounter = metrics.NewRegisteredCounter("yue/pbftAgent/pbftConsensus", nil)
)
...
func NewPbftAgent(yue Backend, config *params.ChainConfig, engine consensus.Engine,
	...
	agent := &PbftAgent{
		...
		vmConfig:             vm.Config{EnablePreimageRecording: yue.Config().EnablePreimageRecording},
		gasFloor:             gasFloor,
		gasCeil:              gasCeil,
