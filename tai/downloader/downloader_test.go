...
type downloadTester struct {
	...
	stateDb taidb.Database // Database used by the tester for syncing from peers
	peerDb  taidb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb = taidb.NewMemDatabase()
