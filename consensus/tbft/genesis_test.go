...
func TestOutGenesisJson(t *testing.T) {
	...
	b, _ := ioutil.ReadFile("E:\\taiyuechain\\src\\github.com\\taiyuechain\\taiyuechain\\cmd\\gtai\\genesis.json")
	...
	for i := 1; i <= 52; i++ {
		...
		e := ioutil.WriteFile("E:\\taiyuechain\\src\\github.com\\taiyuechain\\taiyuechain\\cmd\\gtai\\"+fmt.Sprintf("genesis_%s.json", strconv.Itoa(i)), bytes, os.ModePerm)
		if e != nil {
